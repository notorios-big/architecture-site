...
window.volumeCacheRef = volumeCacheRef;
window.hasDescendant = hasDescendant;
window.sortChildren = sortChildren;
window.sortOnlyAffectedNode = sortOnlyAffectedNode;
window.sortGroupChildren = sortGroupChildren;
